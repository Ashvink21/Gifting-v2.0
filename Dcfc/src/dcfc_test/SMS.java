...
public class SMS extends WebTestBase {
	public static void msg91() throws InterruptedException {
		...
		Thread.sleep(3000);
		String s2 = driver.findElement(By.xpath("html/body/div[3]/div[1]/div[2]/div[1]/div[1]/div[5]/form[1]/table/tbody/tr[1]/td[1]/p")).getText();
		...
		//String s2 = driver.findElement(By.xpath("//*[@id=\"dlrchk_3961446f505a363431313133\"]/td[1]")).getText();
		//System.out.println("Last Send SMS Date&Time:" + s2);
	}
